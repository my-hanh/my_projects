...
public class TimeSeriesData
{
    ...
    public TimeSeriesData(Rigidbody rb, float currentTime, 
                          ...
                          float bumperPositionZ, float bumperVelocityZ, float angularVelocityY, float inertia_y)
    {
        Time = currentTime;
    ...
    {
        return $"{Time},{PositionX},{PositionY},{PositionZ},{VelocityX},{VelocityY},{VelocityZ},{CompressionLeftSpring},{ForceLeftSpring},{CompressionRightSpring},{ForceRightSpring},{BumperPositionZ},{BumperVelocityZ},{AngularVelocityY}, {Inertia}";
    }

    public static string Header()
    {
        // Note: avoid spaces as they would become part of the colum name if imported using pandas!!
        return "t,x,y,z,vx,vy,vz,dl_left,F_left,dl_right,F_right,z_bumper,vz_bumper,angularVelocity_y, inertia_y";
    }
}
